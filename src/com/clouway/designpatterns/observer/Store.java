 ...
 */
public class Store implements ObservedStore {

    private Map<String, Product> listOfProducts = new Hashtable<String, Product>();
    private ObserverForRegisteredProducts observer;
    private ObserverForSoldProducts observerSold;

    /**
     * Add an observer for registered products
     *
     * @param observer observe for new registered products
     */
    ...
    /**
     * Add an observer for sold products
     *
     * @param observer observe for sold products
     */
    public void addObserverForSoldProducts(ObserverForSoldProducts observer) {
        this.observerSold = observer;
    }
    ...
    public void registerProduct(Product product) {
        ...
        if (isProductInStore(product.getProductName())) {
            ...
            observer.update(listOfProducts);
        }
    }
    ...
    public void sellProduct(String productName, int quantity) {
        ...
        observerSold.update(productName, quantity);
    }
     ...
     *
     * @return array list of sorted products
     */
